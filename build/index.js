...
var UserProfileRoutes_1 = require("./routes/UserProfileRoutes");
...
data_source_1.AppDataSource.initialize().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        app.use(UserProfileRoutes_1.default);
        ...
        app.all("*", function (req, res, next) {
            next(new AppError_1.AppError(404, "route ".concat(req.originalUrl, " Not Found")));
        });
