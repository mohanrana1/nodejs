...
var StudentRepo = data_source_1.AppDataSource.getRepository(student_1.student);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, StudentRepo.find().then(function (result) {
                        res.status(200).json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, StudentRepo.save(req.body).then(function (result) {
                        res.status(200).json({
                            message: " Student data has been fetched successfully",
                            data: result
                        });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, StudentRepo.findOneBy({ id: req.params.id }).then(function (result) {
                        res.status(200).json({
                            message: " Student data has been fetched successfully",
                            data: result
                        });
...
var deleteData = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, StudentRepo.findOneBy({ id: req.params.id })];
            case 1:
                Data = _a.sent();
                if (!Data) {
                    return [2 /*return*/, next(new AppError_1.AppError(400, 'data with this id not found'))];
                }
                return [4 /*yield*/, StudentRepo.softRemove(Data).then(function (result) {
                        res.status(200).json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, StudentRepo.save(data).then(function (result) {
                        res.status(200).json({
